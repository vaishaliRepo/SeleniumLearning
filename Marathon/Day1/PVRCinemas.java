...
public class PVRCinemas {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.xpath("//div[@class='quick-lefts ']//span[@class='p-button-label p-c']")).click();

        // Accept Terms and Conditions
        driver.findElement(By.xpath("//button[contains(text(),Accept) and @class='sc-kCuUfV iBvycX reject-terms']"))
                .click();
        ...
        String BookingSum = driver.findElement(By.className("booking-summary")).getText();
        System.out.println("Booking summary details:  " + BookingSum);
        Thread.sleep(2000);

        // Capture and print Grand Total from Booking Summary
        String total = driver.findElement(By.xpath("//div[@class='grand-tota col-md-3']//h6//span")).getText();
